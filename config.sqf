if(isServer) then {
	...
	/* AI CONFIG */
		...
		ai_skill_extreme			= [["aimingAccuracy",0.20],["aimingShake",1.00],["aimingSpeed",1.00],["endurance",1.00],["spotDistance",1.00],["spotTime",1.00],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",1.00]]; 	// Extreme
		ai_skill_hard				= [["aimingAccuracy",0.20],["aimingShake",0.80],["aimingSpeed",0.80],["endurance",1.00],["spotDistance",0.80],["spotTime",0.80],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",1.00]]; 	// Hard
		...
		ai_skill_easy				= [["aimingAccuracy",0.20],["aimingShake",0.50],["aimingSpeed",0.50],["endurance",1.00],["spotDistance",0.50],["spotTime",0.50],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",1.00]];	// Easy
		...
		ai_gear0					= [["FoodPistachio","ItemSodaCoke","ItemBandage","ItemBandage","ItemPainkiller"],["ItemKnife","ItemFlashlight","ItemMatchbox","ItemMachete"]];
		ai_gear1					= [["FoodNutmix","ItemSodaPepsi","ItemBandage","ItemBandage","ItemPainkiller"],["ItemKnife","ItemFlashlight","ItemCrowbar","ItemMatchbox"]];
		ai_gear_random				= [ai_gear0,ai_gear1];	// Allows the possibility of random gear

		ai_wep_assault				= [["M16A4_ACG","30Rnd_556x45_Stanag"],["Sa58V_RCO_EP1","30Rnd_762x39_AK47"],["SCAR_L_STD_Mk4CQT","30Rnd_556x45_Stanag"],["M8_sharpshooter","30Rnd_556x45_Stanag"],["M4A1_HWS_GL_camo","30Rnd_556x45_Stanag"],["SCAR_L_STD_HOLO","30Rnd_556x45_Stanag"],["M4A3_CCO_EP1","30Rnd_556x45_Stanag"],["M4A3_CCO_EP1","30Rnd_556x45_Stanag"],["M4A1_AIM_SD_camo","30Rnd_556x45_StanagSD"],["M16A4","30Rnd_556x45_Stanag"],["m8_carbine","30Rnd_556x45_Stanag"],["BAF_L85A2_RIS_Holo","30Rnd_556x45_Stanag"],["Sa58V_CCO_EP1","30Rnd_762x39_AK47"],["FHQ_ACR_WDL_G33_GL_F","FHQ_rem_30Rnd_680x43_ACR"],["FHQ_ACR_BLK_G33_GL_F","FHQ_rem_30Rnd_680x43_ACR"],["RH_hk417acog","RH_20Rnd_762x51_hk417"],["vil_AKMSB","30Rnd_762x39_AK47"],["vil_AKMS_GP25","30Rnd_762x39_AK47"],["vil_Galil_arm","Vil_35Rnd_556x45_G"],["vil_Galil","Vil_35Rnd_556x45_G"],["RH_ctar21glacog","30Rnd_556x45_Stanag"],["RH_massdeotech","30Rnd_556x45_StanagSD"],["RH_ctar21m","30Rnd_556x45_Stanag"],["RH_ctar21","30Rnd_556x45_Stanag"],["RH_ctar21mgl","30Rnd_556x45_Stanag"],["RH_masaim","30Rnd_556x45_Stanag"],["RH_masbacog","30Rnd_556x45_Stanag"],["RH_masbeotech","30Rnd_556x45_Stanag"],["vil_G3a3","vil_20Rnd_762x51_G3"],["vil_G3a2","vil_20Rnd_762x51_G3"],["vil_G3a4","vil_20Rnd_762x51_G3"],["vil_G3ZF","vil_20Rnd_762x51_G3"]];	// Assault
		ai_wep_machine				= [["RPK_74","75Rnd_545x39_RPK"],["MK_48_DZ","100Rnd_762x51_M240"],["M249_EP1_DZ","200Rnd_556x45_M249"],["Pecheneg_DZ","100Rnd_762x54_PK"],["M240_DZ","100Rnd_762x51_M240"],["vil_FnMag","100Rnd_762x51_M240"],["vil_RPK74M_P29","75Rnd_545x39_RPK"],["vil_M240_B","100Rnd_762x51_M240"],["vil_MG4E","200Rnd_556x45_M249"],["vil_PKP_EOT","100Rnd_762x54_PK"],["vil_Mg3","100Rnd_762x51_M240"],["skavil_M60","100Rnd_762x51_M240"]];	// Light machine guns
		ai_wep_sniper				= [["M14_EP1","20Rnd_762x51_DMR"],["SCAR_H_LNG_Sniper_SD","20Rnd_762x51_SB_SCAR"],["M110_NVG_EP1","20rnd_762x51_B_SCAR"],["SVD_CAMO","10Rnd_762x54_SVD"],["VSS_Vintorez","20Rnd_9x39_SP5_VSS"],["DMR","20Rnd_762x51_DMR"],["M40A3","5Rnd_762x51_M24"],["FHQ_RSASS_TAN","FHQ_rem_20Rnd_762x51_PMAG_NT"],["vil_M14","20Rnd_762x51_DMR"],["USSR_cheytacM200","USSR_5Rnd_408"],["vil_M21G","20Rnd_762x51_DMR"],["vil_SV_98","vil_10Rnd_762x54_SV"],["vil_VSS_PSO","10Rnd_9x39_SP5_VSS"],["vil_SR25SD","20Rnd_762x51_DMR"],["vil_SVDK","vil_10Rnd_SVDK"],["RH_hk417s","20Rnd_762x51_DMR"],["vil_G3SG1","vil_20Rnd_762x51_G3"],["vil_G3sg1b","vil_20Rnd_762x51_G3"]];	// Sniper rifles
	...
	/* WAI MISSIONS CONFIG */
		...
		wai_near_water				= 100;								// nearest water allowed near missions
		...
		// Vehicle arrays
		armed_vehicle 				= ["ArmoredSUV_PMC_DZE","GAZ_Vodnik_DZE","HMMWV_M1151_M2_CZ_DES_EP1_DZE","HMMWV_M998A2_SOV_DES_EP1_DZE","LandRover_MG_TK_EP1_DZE","LandRover_Special_CZ_EP1_DZE","Offroad_DSHKM_Gue_DZE","Pickup_PK_GUE_DZE","Pickup_PK_INS_DZE","Pickup_PK_TK_GUE_EP1_DZE","UAZ_MG_TK_EP1_DZE","BRDM2_HQ_TK_GUE_EP1","HMMWV_Armored","BAF_Jackal2_GMG_W","LAV25_HQ","UAZ_AGS30_CDF","UAZ_MG_CDF","UAZ_SPG9_INS","BTR40_MG_TK_INS_EP1","UAZ_MG_TK_EP1","HMMWV_M2","Offroad_DSHKM_Gue"];
		armed_chopper 				= ["CH_47F_EP1_DZE","UH1H_DZE","Mi17_DZE","UH60M_EP1_DZE","UH1Y_DZE","MH60S_DZE","AH6J_EP1_DZ","CH_47F_EP1","CH_47F_BAF","Mi171Sh_CZ_EP1","Mi17_TK_EP1","Mi17_UN_CDF_EP1","Mi17_CDF","Mi17_INS","UH60M_EP1","UH60M_EP1_DZ","UH1Y_DZ","UH1H_TK_EP1","MH60S","UH1H_TK_GUE_EP1"];
		civil_chopper 				= ["AH6X_DZ","BAF_Merlin_DZE","MH6J_DZ","Mi17_Civilian_DZ","CH53_DZE","Mi17_Civilian","Mi17_medevac_CDF","Mi17_medevac_RU","Mi17_medevac_INS","UH60M_MEV_EP1","BAF_Merlin_HC3_D"];
		...
		refuel_trucks				= ["KamazRefuel_DZ","MtvrRefuel_DES_EP1_DZ","UralRefuel_TK_EP1_DZ","V3S_Refuel_TK_GUE_EP1_DZ","KamazRefuel","MtvrRefuel_DES_EP1","MtvrRefuel","UralRefuel_CDF","UralRefuel_INS","UralRefuel_TK_EP1","V3S_Refuel_TK_GUE_EP1","MtvrReammo_DES_EP1","MtvrRepair_DES_EP1","V3S_Reammo_TK_GUE_EP1","V3S_Repair_TK_GUE_EP1","KamazReammo","KamazRepair","MtvrReammo","MtvrRepair"];
		...
		crate_items_buildables		= ["ItemWoodWallGarageDoor",["ItemWoodWallWindowLg",4],["ItemWoodWallLg",8],["metal_floor_kit",4],["ItemWoodFloor",4],"outhouse_kit",["desert_net_kit",5],["forest_net_kit",5],"deer_stand_kit","ItemWoodLadder",["cinder_wall_kit",5]"Itemvault","ItemWoodStairs","wood_shack_kit","forest_large_net_kit","cinder_garage_kit",["PartPlywoodPack",5],"ItemSandbagExLarge5X","park_bench_kit","ItemComboLock",["CinderBlocks",50],"ItemCanvas",["ItemLightBulb",5],"ItemLockbox",["ItemSandbag",10],["ItemTankTrap",10],["ItemWire",10],["MortarBucket",10],["PartPlankPack",5],"PartWoodPile"];
